...
pattern_dict = { 
    "circle" : {'thumbnail' : THUMBNAIL_LIST[0], 'pattern' : PATTERN_LIST[0], 'price' : 5}, 
    "square" : {'thumbnail' : THUMBNAIL_LIST[1], 'pattern' : PATTERN_LIST[1], 'price' : 10},  
    "triangle" : {'thumbnail' : THUMBNAIL_LIST[2], 'pattern' : PATTERN_LIST[2], 'price' : 15}, #end stage 1 
    "star" : {'thumbnail' : THUMBNAIL_LIST[3], 'pattern' : PATTERN_LIST[3], 'price' : 25},  
    "heart" : {'thumbnail' : THUMBNAIL_LIST[4], 'pattern' : PATTERN_LIST[4], 'price' : 30},  
